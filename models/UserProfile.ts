...
const userProfileSchema = new mongoose.Schema(
  {
    ...
    profession: { type: String, default: null, trim: true, maxlength: 80 },
    expertise: { type: String, default: null, trim: true, maxlength: 80 },
    years_of_experience: { type: String, default: null, trim: true, maxlength: 10 },
    company_type: { type: String, default: null, trim: true, maxlength: 60 },
    verification_preference: { type: String, default: "none", trim: true, maxlength: 40 },
    public_expertise_enabled: { type: Boolean, default: false },
