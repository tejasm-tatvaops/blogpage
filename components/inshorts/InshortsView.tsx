            ...
            >
              {Math.abs(i - activeIndex) > 1 ? (
                ...
                >
                  ...
                  {/* Side actions (vertical, kept away from right nav arrow) */}
                  <div className="absolute bottom-24 right-2 z-20 flex flex-col items-end gap-2 md:bottom-20 md:right-20 lg:right-24">
                    <div
                      className="flex flex-col items-center gap-1.5 rounded-2xl bg-black/35 px-1.5 py-1.5 backdrop-blur-md md:px-2 md:py-2"
                      onClick={(e) => e.stopPropagation()}
                    >
                      <button type="button" aria-label="Share on WhatsApp" onClick={shareWhatsApp} className="flex h-6 w-6 items-center justify-center rounded-full bg-white/10 text-white transition hover:bg-[#25D366]/70 md:h-7 md:w-7">
                      ...
                      <button type="button" aria-label="Share on X (Twitter)" onClick={shareTwitter} className="flex h-6 w-6 items-center justify-center rounded-full bg-white/10 text-white transition hover:bg-black/60 md:h-7 md:w-7">
                        <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor" aria-hidden><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.747l7.73-8.835L1.254 2.25H8.08l4.253 5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
                      </button>
                      <button type="button" aria-label="Share on LinkedIn" onClick={shareLinkedIn} className="flex h-6 w-6 items-center justify-center rounded-full bg-white/10 text-white transition hover:bg-[#0A66C2]/70 md:h-7 md:w-7">
                        <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor" aria-hidden><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" /></svg>
                      </button>
                      <button type="button" aria-label="Share on Threads" onClick={shareThreads} className="flex h-6 w-6 items-center justify-center rounded-full bg-white/10 text-white transition hover:bg-white/30 md:h-7 md:w-7">
                        <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor" aria-hidden><path d="M16.35 11.08c-.12-2.46-1.55-3.86-4.03-3.95h-.13c-1.43 0-2.58.46-3.43 1.36-.8.86-1.24 2.02-1.24 3.3 0 2.69 1.78 4.58 4.32 4.58 2.03 0 3.54-1.16 3.86-2.94.05-.26.08-.53.08-.8 0-.04 0-.08-.01-.12.49.3.83.71 1 1.23.2.63.1 1.29-.29 1.88-.54.82-1.56 1.31-2.72 1.31-2.09 0-3.62-1.3-3.98-3.4-.04-.24-.25-.4-.5-.36-.24.04-.4.26-.36.5.43 2.56 2.39 4.16 4.84 4.16 1.45 0 2.74-.63 3.44-1.69.53-.81.67-1.73.4-2.61-.31-1-.98-1.72-1.95-2.1-.06-.78-.18-1.47-.34-1.95ZM12 14.8c-1.5 0-2.55-1.14-2.55-2.77 0-.99.33-1.87.92-2.47.51-.52 1.2-.79 2.05-.79h.1c1.59.05 2.4.84 2.48 2.43-1.3.06-2.3.3-3.07.74-.96.55-1.42 1.39-1.42 2.57 0 .1.01.2.02.29-.17.01-.34.02-.53.02Zm2.61-1.63c-.2 1.1-1.12 1.78-2.4 1.78-.96 0-1.67-.58-1.67-1.37 0-.89.31-1.43 1-1.83.64-.36 1.53-.57 2.73-.62.02.19.03.39.03.59 0 .49-.03.97-.09 1.45Z" /></svg>
                      </button>
                      <button
                        type="button"
                        ...
                        className="flex h-6 w-6 items-center justify-center rounded-full bg-white/10 text-white transition hover:bg-gradient-to-br hover:from-[#f09433]/70 hover:via-[#e6683c]/70 hover:to-[#bc1888]/70 md:h-7 md:w-7"
                      >
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.94 }}
                      className="rounded-full bg-black/35 px-2.5 py-1.5 text-[11px] font-semibold backdrop-blur-md md:px-3 md:py-2 md:text-xs"
                      onClick={(e) => {
                        e.stopPropagation();
                  ...
                  {/* Bottom content */}
                  <div className="absolute inset-x-0 bottom-0 z-10 pl-5 pr-20 pb-10 pt-4 sm:pl-6 sm:pr-24 md:pl-28 md:pr-10">
                    {/* Badges */}
                    ...
                    <motion.h2
                      ...
                      className="text-[34px] font-extrabold leading-tight sm:text-3xl"
                    >
                      {post.title}
                    </motion.h2>
                    ...
                    <div className="mt-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-2">
                      <a
                        href={`/blog/${post.slug}`}
                        onClick={(e) => e.stopPropagation()}
                        className="inline-flex items-center gap-1.5 rounded-full bg-white/15 px-3 py-1.5 text-xs font-semibold text-white/90 hover:bg-white/25"
                      >
                        Read full article →
                      </a>
                      <a
                        ...
                        onClick={(e) => e.stopPropagation()}
                        className="inline-flex items-center gap-1.5 rounded-full border border-white/20 bg-black/25 px-3 py-1.5 text-xs font-semibold text-white/85 hover:bg-black/35"
                      >
