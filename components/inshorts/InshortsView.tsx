            ...
            >
              {Math.abs(i - activeIndex) > 1 ? (
                ...
                >
                  ...
                  <div className="absolute bottom-20 right-16 z-20 flex flex-col items-end gap-2 md:right-20 lg:right-24">
                    <div
                      className="flex flex-col items-center gap-1.5 rounded-2xl bg-black/35 px-2 py-2 backdrop-blur-md"
                      onClick={(e) => e.stopPropagation()}
                    >
                      <button type="button" aria-label="Share on WhatsApp" onClick={shareWhatsApp} className="flex h-7 w-7 items-center justify-center rounded-full bg-white/10 text-white transition hover:bg-[#25D366]/70">
                      ...
                      <button type="button" aria-label="Share on X (Twitter)" onClick={shareTwitter} className="flex h-7 w-7 items-center justify-center rounded-full bg-white/10 text-white transition hover:bg-black/60">
                      ...
                      <button type="button" aria-label="Share on LinkedIn" onClick={shareLinkedIn} className="flex h-7 w-7 items-center justify-center rounded-full bg-white/10 text-white transition hover:bg-[#0A66C2]/70">
                        <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor" aria-hidden><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" /></svg>
                      </button>
                      <button type="button" aria-label="Share on Threads" onClick={shareThreads} className="flex h-7 w-7 items-center justify-center rounded-full bg-white/10 text-white transition hover:bg-white/30">
                  ...
                  {/* Bottom content */}
                  <div className="absolute inset-x-0 bottom-0 z-10 px-6 pb-10 pt-4 md:pl-28 md:pr-10">
                    {/* Badges */}
