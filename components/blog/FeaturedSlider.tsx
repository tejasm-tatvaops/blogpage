        ...
        {total > 1 && (
          <>
            <button
              ...
              className="absolute left-3 top-1/2 -translate-y-1/2 rounded-full bg-black/45 p-2.5 text-white backdrop-blur transition hover:bg-black/65"
            >
            ...
            <button
              ...
              className="absolute right-3 top-1/2 -translate-y-1/2 rounded-full bg-black/45 p-2.5 text-white backdrop-blur transition hover:bg-black/65"
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round">
